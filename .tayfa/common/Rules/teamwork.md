...
**Статусы спринта:** `активный` → `завершён` → **архивирован**.

**Архивация:** После завершения спринт автоматически архивируется в `.tayfa/common/archive/S00X/`. См. [sprint-archive.md](sprint-archive.md).
...
- **⛔ Архив закрыт для агентов** — `.tayfa/common/archive/` содержит завершённые спринты. Агенты НЕ читают и НЕ используют архивные данные. Архив — только для пользователя.
...
- [testing.md](testing.md) — правила тестирования, обязательные автотесты, быстрые/медленные тесты
- [product-docs.md](product-docs.md) — правила ведения продуктовой документации (docs/product/)
- [sprint-archive.md](sprint-archive.md) — архивация завершённых спринтов
- [employees.md](employees.md) — список сотрудников и их роли
- [git-workflow.md](git-workflow.md) — работа с Git
