"""
Create a Cursor CLI chat for a single agent (via WSL) and save it to .cursor_chats.json.
Usage: python cursor_create_chat.py boss
"""
import asyncio
import json
import sys
...
async def create_chat():
    ...
    if out_text and proc.returncode == 0:
        try:
            ...
            pass
        # Sometimes create-chat returns just a UUID string (not JSON)
