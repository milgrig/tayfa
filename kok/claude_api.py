...
from user_data import CLAUDE_API_LOG_FILE, AGENTS_FILE as _UD_AGENTS_FILE
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(str(CLAUDE_API_LOG_FILE), encoding="utf-8"),
    ]
)
...
AGENTS_FILE = str(_UD_AGENTS_FILE)
